...
const goals = {
    ...
    objetivo2: "Me gustaría conocer recetas veganas",
    objetivo3: "Quiero consumir mas proteina para ganar mas masa muscular",
}

export const EvaluationObj3 = ({list, setList, finish, setFinish}) => {
    ...
    const [goal1, setGoal1] = useState({
        id: 1,
        obj: "Disminuir mi consumo de azúcar",
        estado: false
    });
    const [goal2, setGoal2] = useState({
        id: 2,
        obj: "Me gustaría conocer recetas veganas",
        estado: false
    });
    const [goal3, setGoal3] = useState({
        id: 3,
        obj: "Quiero consumir mas proteina para ganar mas masa muscular",
        estado: false
    });
    ...
    return (
        <div style={{marginTop: '150px', marginBottom: '200px'}}>
            ...
            <h1 className="font-bold text-center">Quiero mejorar mi alimentación</h1>
