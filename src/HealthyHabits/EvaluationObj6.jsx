...
const goals = {
    objetivo1: "Aumentar la ingesta calórica",
    objetivo2: "Incrementar el consumo de proteínas",
    objetivo3: "Incluir alimentos densos en nutrientes",
}

export const EvaluationObj6 = ({list, setList, finish, setFinish}) => {
    ...
    const [goal1, setGoal1] = useState({
        id: 1,
        obj: "Aumentar la ingesta calórica",
        estado: false
    });
    const [goal2, setGoal2] = useState({
        id: 2,
        obj: "Incrementar el consumo de proteínas",
        estado: false
    });
    const [goal3, setGoal3] = useState({
        id: 3,
        obj: "Incluir alimentos densos en nutrientes",
        estado: false
    });
    ...
    return (
        <div style={{marginTop: '150px', marginBottom: '200px'}}>
            ...
            <h1 className="font-bold text-center">Quiero ganar peso</h1>
