...
const goals = {
    objetivo1: "Incrementar el consumo de alimentos ricos en nutrientes",
    objetivo2: "Priorizar las fuentes de proteína magra",
    objetivo3: "Equilibrar los carbohidratos complejos",
}

export const EvaluationObj5 = ({list, setList, finish, setFinish}) => {
    ...
    const [goal1, setGoal1] = useState({
        id: 1,
        obj: "Incrementar el consumo de alimentos ricos en nutrientes",
        estado: false
    });
    const [goal2, setGoal2] = useState({
        id: 2,
        obj: "Priorizar las fuentes de proteína magra",
        estado: false
    });
    const [goal3, setGoal3] = useState({
        id: 3,
        obj: "Equilibrar los carbohidratos complejos",
        estado: false
    });
    ...
    return (
        <div style={{marginTop: '150px', marginBottom: '200px'}}>
            ...
            <h1 className="font-bold text-center">Quiero mejorar mi forma física</h1>
