...
const goals = {
    objetivo1: "Necesito enfocarme mas en mis tareas diarias",
    objetivo2: "Quiero mejorar mi desempeño en el trabajo",
    objetivo3: "Me gustaría conocer herramientas que me ayuden a organizarme mejor",
}

export const EvaluationObj2 = ({list, setList, finish, setFinish}) => {
    ...
    const [goal1, setGoal1] = useState({
        id: 1,
        obj: "Necesito enfocarme mas en mis tareas diarias",
        estado: false
    });
    const [goal2, setGoal2] = useState({
        id: 2,
        obj: "Quiero mejorar mi desempeño en el trabajo",
        estado: false
    });
    const [goal3, setGoal3] = useState({
        id: 3,
        obj: "Me gustaría conocer herramientas que me ayuden a organizarme mejor",
        estado: false
    });
    ...
    return (
        <div style={{marginTop: '150px', marginBottom: '200px'}}>
            ...
            <h1 className="font-bold text-center">Quiero ser mas productivo</h1>
